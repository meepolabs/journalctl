"""OpenTelemetry setup module for journalctl (TASK-03.19).
...
def _build_resource() -> Any:
    ...
    Reads OTEL_SERVICE_NAME (default "journalctl") and
    OTEL_RESOURCE_ATTRIBUTES (comma-separated key=value pairs).
    """
    from opentelemetry.sdk.resources import Resource  # noqa: PLC0415

    service_name = os.environ.get(_OTEL_SERVICE_NAME_ENV, "journalctl")
...
def configure_otel(app: FastAPI) -> None:  # noqa: C901
    ...
    logger.info("Configuring OpenTelemetry for journalctl")
